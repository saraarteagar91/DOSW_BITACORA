...
public class ImageEditor {
    ...
    public ImageEditor(String f) {
        ctx=new ImageContext(new BaseImage(f));
    }
    public void apply(ImageCommand c) {
        c.execute();
        history.push(c);
        redoStack.clear();
        print();
    ...
    public void redo() {
        ...
        ImageCommand c=redoStack.pop();
        c.execute();
        history.push(c);
        print();
    }
    private void print() {
        System.out.println("Vista: " + ctx.getCurrent().render() + "\n");
    }
}
